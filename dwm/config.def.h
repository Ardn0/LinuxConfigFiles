...
static const char *const autostart[] = {
	"sh", "-c", "xrandr --output eDP --set TearFree on --mode 1920x1200", NULL,
	"sh", "-c", "setxkbmap -layout us,cz -option grp:win_space_toggle", NULL,
	"sh", "-c", "~/.config/dwm/mojeNastaveni.sh", NULL,
	"sh", "-c", "~/.config/dwm/status.sh", NULL,
	NULL /* terminate */
};
...
static const Rule rules[] = {
	...
	{ "Nwg-look",	"nwg-look",	"nwg-look",	0, 			1,           -1 },
};
...
static const char *loweVolume[]  = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-5%", NULL };
static const char *raiseBrightness[] = { "light", "-A", "1", NULL };
static const char *lowerBrightness[] = { "light", "-U", "1", NULL };
...
static const Key keys[] = {
	...
	{ 0,      		 	XF86XK_AudioLowerVolume, 	   spawn,          {.v = loweVolume } },
